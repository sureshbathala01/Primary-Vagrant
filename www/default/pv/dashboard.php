...
<h2>Development Sites</h2>
	...
	<ul>
		...
		<li><a href="http://legacy.wordpress.pv" target="_blank">WordPress Legacy Branch (old version - 4.3.x)</a></li>
		<li><a href="http://stable.wordpress.pv" target="_blank">WordPress Stable Branch (current version - 4.4.x)</a></li>
