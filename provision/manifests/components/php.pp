  ...
  extensions   => {
    ...
    xdebug       => {
      ...
      settings        => {
        ...
        'XDEBUG/xdebug.trace_output_dir'          => '/vagrant/userdata/debug',
        ...
        'XDEBUG/xdebug.profiler_output_dir'       => '/vagrant/userdata/debug',
        'XDEBUG/xdebug.remote_enable'             => '1',
        'XDEBUG/xdebug.remote_mode'               => 'req',
        'XDEBUG/xdebug.remote_host'               => '192.168.13.1',
        'XDEBUG/xdebug.remote_log'                => '/vagrant/userdata/debug/xdebug-remote.log',
