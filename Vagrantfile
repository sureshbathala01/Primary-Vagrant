...
Vagrant.configure("2") do |config|
	...
	config.vm.synced_folder "sites/wordpress/content", "/var/www/wordpress/stable/wordpress/content", :owner => "www-data", :mount_options => [ "dmode=775", "fmode=774" ]
	config.vm.synced_folder "sites/wordpress/content", "/var/www/wordpress/trunk/wordpress/content", :owner => "www-data", :mount_options => [ "dmode=775", "fmode=774" ]
	config.vm.synced_folder "sites/wordpress/content", "/var/www/wordpress/last/wordpress/content", :owner => "www-data", :mount_options => [ "dmode=775", "fmode=774" ]
