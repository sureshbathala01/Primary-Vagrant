...
<h2>Development Sites</h2>
	...
	<ul>
		...
		<li><a href="http://legacy.wordpress.pv/wordpress" target="_blank">WordPress Legacy Branch (old version - 4.0.1)</a></li>
		<li><a href="http://stable.wordpress.pv/wordpress" target="_blank">WordPress Stable Branch (current version - 4.1.1)</a></li>
		<li><a href="http://trunk.wordpress.pv/wordpress" target="_blank">WordPress Trunk (development) Version</a></li>
	</ul>
